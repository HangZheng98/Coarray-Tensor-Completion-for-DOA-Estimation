...
RMSE_CPA_TensorCompletion_theta_SNR = sqrt(RMSE_CPA_TensorCompletion_theta_SNR/(K*Trial));
RMSE_CPA_TensorCompletion_fe_SNR = sqrt(RMSE_CPA_TensorCompletion_fe_SNR/(K*Trial));
...
RMSE_CPA_TensorCompletion_theta_SNAP = sqrt(RMSE_CPA_TensorCompletion_theta_SNAP/(K*Trial));
RMSE_CPA_TensorCompletion_fe_SNAP = sqrt(RMSE_CPA_TensorCompletion_fe_SNAP/(K*Trial));